		...
		<view class="content" v-if="tabIndex == 0">
			...
			<view class="card">
				<up-cell-group :border="false">
					...
					<up-cell title="客户名称" value="合同的客户" :isLink="false" arrow-direction="right" :required="false"></up-cell>
					<up-cell title="企业税号" value="根据客户信息显示" :isLink="false" arrow-direction="right" :required="false"></up-cell>
				...
				<view class="card">
					<up-cell-group :border="false">
						...
						<up-cell title="收款金额" value="IS9001" :isLink="true" arrow-direction="right" :required="false"></up-cell>
				...
				<view class="card">
					<up-cell-group :border="false">
						<up-cell title="收款类型" value="IS9001" :isLink="true" arrow-direction="right" :required="true"></up-cell>
						<up-cell title="收款账户" value="5000" :isLink="true" arrow-direction="right" :required="true"></up-cell>
						...
						<up-cell title="支付单位" value="5000" :isLink="true" arrow-direction="right" :required="true"></up-cell>
					</up-cell-group>
				</view>
				<view class="textClass up-m-t-20">
					<textarea type="textarea" placeholder="收款备注" border="surround" v-model="textValue"></textarea>
				</view>
			</view>
