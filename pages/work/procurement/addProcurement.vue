<template>
	<view>
		<up-navbar title="采购管理" :placeholder="true" :autoBack="true" />
		...
		<view class="content" v-if="tabIndex==0">
			<view class="card">
				<up-cell-group :border="false">
					<up-cell title="采购申请人" value="默认自己" :isLink="true" arrow-direction="right" :required="true"></up-cell>
					<up-cell title="采购流程" value="选择的流程" :isLink="true" arrow-direction="right" :required="true"></up-cell>
					<up-cell title="办理人" value="根据流程显示" :isLink="true" arrow-direction="right" :required="true"></up-cell>
					<up-cell title="联系人" :required="false" :isLink="false">
						<template #value>
							<input v-model="name" placeholder="请输入" type="text" style="text-align:right;font-size:26rpx;" />
						</template>
					</up-cell>
					<up-cell title="联系电话" :required="false" :isLink="false">
						<template #value>
							<input v-model="name" placeholder="请输入" type="text" style="text-align:right;font-size:26rpx;" />
						</template>
					</up-cell>
					<up-cell title="供应商" value="选择的供应商" :isLink="true" arrow-direction="right" :required="false"></up-cell>
				</up-cell-group>
			...
			<view class="card">
				<up-cell-group :border="false">
					...
					<up-cell title="联系电话" :required="true" :isLink="false">
						<template #value>
							<input v-model="name" placeholder="请输入" type="text" style="text-align:right;font-size:26rpx;" />
						</template>
					</up-cell>
					...
					<up-cell title="总金额" :isLink="false" arrow-direction="right" :required="false">
						<template #right-icon>
			...
			<view class="u-flex u-row-between u-col-center">
				...
				<view class="u-flex u-col-center">
					<view class="up-m-r-10" style="font-size: 26rpx;color: #B7C4D7;">添加付款方式</view>
					<up-icon name="plus-circle" size="20px" color="#5A78A0"></up-icon>
				</view>
			</view>
			<view class="card up-m-t-20">
				<up-cell title="付款方式" :required="true" :isLink="false">
					<template #value>
						<input v-model="name" placeholder="请输入" type="text" style="text-align:right;font-size:26rpx;" />
					</template>
				</up-cell>
		...
		<view v-if="tabIndex==1">
			...
			<view class="taskbox">
				<view class="taskItem">
					...
					<view class="tasktext">采购单号：27395893</view>
					<view class="tasktext">联系人：葫芦娃</view>
					<view class="tasktext">联系电话：23795489359</view>
