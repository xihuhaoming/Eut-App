<template>
	<view class="">
		<up-navbar title="成本支付详情" :placeholder="true" :autoBack="true" />
		<view class="conTop">
			<view class="time">2023.02.12 16:00:00</view>
			<view class="title bold">易尤特提交的成本支出申请</view>
		...
		<view class="conZho">
			...
			<view class="zhoItem u-flex u-col-center">
				<view class="zhoLf">时间</view>
				<view class="zhoRi up-m-l-30">易尤特集团</view>
			</view>
			<view class="zhoItem u-flex u-col-center">
				<view class="zhoLf">客户名称</view>
				<view class="zhoRi up-m-l-30">3279596</view>
			</view>
			<view class="zhoItem u-flex u-col-center">
				<view class="zhoLf">供应商</view>
				<view class="zhoRi up-m-l-30">3279596</view>
			</view>
			<view class="zhoItem u-flex u-col-center">
				<view class="zhoLf">合同已收款</view>
				<view class="zhoRi up-m-l-30">3279596</view>
			</view>
			<!-- 	<view class="zhoItem u-flex u-col-center">
			...
			<view class="zhoLf">支付明细</view>
			<view class="textClass up-m-t-20">
				<view>如怀疑存在 DNS 劫持，可尝试更换 D</view>
			</view>
			<view class="zhoItem">
				<view class="zhoLf">附件</view>
				<view class="u-flex up-m-t-20">
					<image class="up-m-l-20" style="width:124rpx;height:124rpx" src="/static/logo.png"></image>
				</view>
			</view>
		</view>
		<view class="fengx"></view>
		<view class="conZho">
			<view class="xinx bold up-m-b-20">支付信息</view>
			<view class="zhoItem u-flex u-col-center">
				<view class="zhoLf">收款单位</view>
				<view class="zhoRi up-m-l-30">星湖测试技术（苏州）有限公司</view>
			</view>
			<view class="zhoItem u-flex u-col-center">
			...
			<view class="zhoItem u-flex u-col-center">
				<view class="zhoLf">账号</view>
				<view class="zhoRi up-m-l-30">2023.02.12 16:00:00</view>
			</view>
			<view class="zhoItem u-flex u-col-center">
				<view class="zhoLf">支付单位</view>
				<view class="zhoRi up-m-l-30">2023.02.12 16:00:00</view>
			</view>
		</view>
		<view class="fengx"></view>
